...
const Footer = () => {
  return (
    <div className='w-full h-[105vh] flex px-14 pt-[116px] pb-6'>
        <div className="w-1/2 h-full flex flex-col justify-between">
            <div className="heading font-[FoundersGrotesk] leading-[13vh] text-[18vh]">
                <h1>EYE-</h1>
                <h1>OPENING</h1>
            </div>
            <div className="svg">
        ...
        <div className="w-1/2 h-full flex flex-col justify-between">
            ...
            <div className="dets flex justify-between font-[NeueMontreal]">
            <div className='flex flex-col'>
                    S:
                    <a className='mt-2 underline decoration-1 underline-offset-2' href="#">Instagram</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Behance</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Facebook</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Linkedin</a>
                </div>
                <div className='flex flex-col mr-10'>
                    M:
                    <a className='mt-2 underline decoration-1 underline-offset-2' href="#">Home</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Services</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Our work</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">About us</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Insights</a>
                    <a className='underline decoration-1 underline-offset-2' href="#">Contact us</a>
                </div>
            </div>

            <div className='©-dets flex justify-between text-[#b1afaf]'>
                <h3>© ochi design 2024. Legal Terms</h3>
